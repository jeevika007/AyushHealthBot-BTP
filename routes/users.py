...
# 🔹 Disease Prediction 
# ==============================
@users.route('/predict-disease')
@login_required
def predict_disease():
    return render_template("predict_disease.html")

# ==============================
# 🔹 Registering the prediction blueprints
# ==============================
users.register_blueprint(alzhimer_bp, url_prefix='/alzhimer')
users.register_blueprint(diabetes_bp, url_prefix='/diabetes')
users.register_blueprint(heart_bp, url_prefix='/heart')
users.register_blueprint(liver_bp, url_prefix='/liver')
users.register_blueprint(parkinsons_bp, url_prefix='/parkinsons')
users.register_blueprint(stroke_bp, url_prefix='/stroke')
users.register_blueprint(anemia_bp, url_prefix='/anemia')
users.register_blueprint(asthma_bp, url_prefix='/asthma')
users.register_blueprint(pcos_bp, url_prefix='/pcos')
...
def ask_question():
    ...
    flash('Your question has been submitted successfully. A doctor will answer it soon.', 'success')
    return redirect(url_for('users.dashboard'))
